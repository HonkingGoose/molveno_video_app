...
if [ -z ${default_username} ]; then
    echo -e "ERROR: shell script 'default_username' variable is empty."
    exit
fi

if [ -z ${default_password} ]; then
    echo -e "ERROR: shell script 'default_password' variable is empty."
    exit
fi

if [ -z ${docker_database_password} ]; then
    echo -e "ERROR: shell script 'docker_database_password' variable is empty."
    exit
fi
